...
#A Selenium script to login and create an incident in a ServiceNow Instance

# variables
sninstance = 'https://dev1234.service-now.com'
sninstanceuser = 'itil'
...
assignmentGroup = browser.find_element(By.ID,
...
shortDescription = browser.find_element(By.ID,
        'incident.short_description')
shortDescription.send_keys('Testing Selenium Incident creation')
